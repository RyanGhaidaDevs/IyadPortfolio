...
class ProjectShowPage extends React.Component {
  ...
  render() {
    const images = [
      { url: require("./Projects/VPGS/Images/1.jpg") },
      { url: require("./Projects/VPGS/Images/2.jpg") },
      { url: require("./Projects/VPGS/Images/3.jpg") },
      { url: require("./Projects/VPGS/Images/4.jpg") },
      { url: require("./Projects/VPGS/Images/5.jpg") }
  ];
    return (
    <div className={"showPage"}> 
    <div className={"showPageChild"}> 
      <h1> Project Title </h1> 
      <SimpleImageSlider
                    width={800}
                    height={600}
